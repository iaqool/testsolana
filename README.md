...
3. `mint_tokens` и `transfer_tokens` делают CPI вызовы SPL Token.
...
mint_tokens | Mint 500 токенов | Баланс ATA == 500 |
...
**Почему баланс именно 500 / 200?**  
Просто округлые числа для читабельности. Можно поменять без последствий.
